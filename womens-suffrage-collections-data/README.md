# Women's Suffrage Collections at NYPL and Library of Congress
...
## About the data
The data was created by harvesting the MODS XML records through each collection's API and crosswalking selected elements to a tabular format using Python scripts at https://github.com/saverkamp/loc-talk-2017/tree/master/womens-suffrage-collections-data/scripts."

### Data dictionary

| Field Name           | Required | Type (Format) | Description                                                                                                                                                                                |
|----------------------|----------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Source               | true     | string        | The institutional owner of the item. 'NYPL' or 'LoC.'                                                                                                                                      |
| Primary ID           | true     | string        | The primary identifier for the digitized item, unique to the source institution.                                                                                                           |
| Title                | true     | string        | The primary title for the item.                                                                                                                                                            |
| Alternative title    | false    | string        | A pipe-delimited list of additional titles for the item.                                                                                                                                   |
| Contributor          | false    | string        | A pipe-delimited list of persons or organizations that contributed to the creation of the content. Names are usually taken from Library of Congress Name Authority File.                   |
| Abstract             | false    | string        | A summary or description of the content.                                                                                                                                                   |
| Date                 | false    | string        | A pipe-delimited list of dates or date ranges related to the creation of the content.                                                                                                      |
| Genre                | false    | string        | A pipe-delimited list of terms describing the nature of the content.                                                                                                                       |
| Topical subject      | false    | string        | A pipe-delimited list of topical terms describing the content. Terms are usually taken from LCSH and may have been part of complex subject headings.                                       |
| Name subject         | false    | string        | A pipe-delimited list of persons or organizations the content depicts or contains. Terms are usually taken from LC Name Authority File and may have been part of complex subject headings. |
| Geographic subject   | false    | string        | A pipe-delimited list of places related to the content. Terms are usually taken from LCSH and may have been part of complex subject headings.                                              |
| Title subject        | false    | string        | A pipe-delimited list of works the content is about. Terms may have been part of complex subject headings.                                                                                 |
| Temporal subject     | false    | string        | A pipe-delimited list of time periods describing the content. Terms may have been part of complex subject headings.                                                                        |
| Type of resource     | true     | string        | A pipe-delimited list of terms that specify the characteristics and general type of content of the resource. Terms taken from the MODS controlled vocabulary for type of resource.         |
| Place of publication | false    | string        | A pipe-delimited list of places related to the publication, distribution, or manufacture of the item.                                                                                      |
| Publisher            | false    | string        | A pipe-delimited list of names related to the publication, distribution, or manufacture of the item.                                                                                       |
| Form                 | false    | string        | A pipe-delimited list of terms describing the physical format of the item.                                                                                                                 |
